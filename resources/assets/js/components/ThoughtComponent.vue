...
<script>
    export default {
        ...
        methods: {
            onClickDelete() {
                axios.delete(`http://localhost:8080/Ejemplo/veujs_laravel/public/thoughts/${this.thought.id}`).then(() => {
                    this.$emit('delete');
                });
            },
            onClickEdit() {
            ...
            onClickUpdate() {
                ...
                axios.put(`http://localhost:8080/Ejemplo/veujs_laravel/public/thoughts/${this.thought.id}`, params).then((response) => {
                    this.editMode = false;
